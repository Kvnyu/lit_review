...
// == Genetic algorithms
// TODO: write this, compare with the above maybe?
// Strengths, weaknesses, helps later on when you have to explain what is good about what we're doing and why we should maybe use something else.
...
// - Normally we just send the variables to the bb function, get objective value
...
// - Add more details about MiniZinc and how it works
// - Look at MiniZinc with functions
// - What will happen when we do that with Black Boxes. 

// - Learning solvers, works similar to branch and bound. Chuffed keeps track of decisions made. Makes new constraints from the problem, jump back up.
